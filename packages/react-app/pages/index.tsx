...
export default function Home() {
    ...
    return (
        ...
        {address && (
            <div className="h1">
            Hello CyberFren! Send cUSDC to yourself to save for artist/sport merch and/or waive this by answering cybersecurity questions
        </div>
        )}
                ...
                <>
                    ...
                    <div className="w-full px-3 mt-7">
                        <PrimaryButton
                            ...
                            onClick={sendingCUSD}
                            title="Send 0.1 cUSD to your own address to save for merch"
                            widthFull
                        />
                    </div>
                    ...
                    <div className="w-full px-3 mt-6">
                        <PrimaryButton
                            loading={cUSDLoading}
                            onClick={signMessage}
                            title="Sign a Message to prove that you own the wallet for cybersecurity"
                            widthFull
                        />
                    </div>
                    ...
                    {userOwnedNFTs.length > 0 ? (
                        ...
                        <div className="mt-5">You do not have any NFTs yet, answer a cybersecurity question in 'challenges' to redeem</div>
                    )}
